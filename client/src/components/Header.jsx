    ...
    <div className='mx-8 sm:mx-16 xl:mx-24 relative'>
      <div className='text-center mt-20 mb-8'>
        <div className='inline-flex items-center justify-center gap-4 px-6 py-1.5 mb-4 border border-primary/40 bg-primary/10 rounded-full text-sm text-primary'>
            <p>OFFICIAL : IIT PATNA NEWS LETTER</p>
            <img src={assets.logo} alt="logo" className='w-2.5' />
        </div>
        <h1 className='text-3xl sm:text-6xl font-semibold sm:leading-16 text-gray-700'>Your Own <span className='text-primary'>Students</span> <br/> Platform.</h1>
      ...
      {/*<img src={''} alt="bgimage" className='absolute-top-50-z-1 opacity-50' />*/}
    </div>
  )
}
